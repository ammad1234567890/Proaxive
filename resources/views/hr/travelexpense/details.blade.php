        ...
        <div class="row mg-b-25">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <br />
                    <label class="form-control-label">
                        <b>{{$data['data'][0]->employee_email}}</b>
                    </label>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <label class="form-control-label">
                        <b> 
                            <a 
                                href="{{asset('passports')}}/{{$data['data'][0]->employee_passport_attachment}}"
                                target="_blank"> <i class="fa fa-paperclip"></i> See Attached</a>
                        </b>
                    </label>
                </div>
            </div>
