	...
	<div id="modaldemo4" class="modal fade">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form method="post" action="{{url('md_approval')}}" id="approval_form_approved">
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-info pd-x-20" id="submit_approved">Approved</button>
...
<script>
    $(document).ready(function(){
        $('.designation_table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{url('get_md_approvals_list')}}",
            columnDefs: [{
                "orderSequence": ["desc"],
                targets: [0],
        ...
        $("#submit_approved").click(function(){

                $("#submit_approved").attr('disabled', true);
                $('#submit_approved').html('Please wait');
