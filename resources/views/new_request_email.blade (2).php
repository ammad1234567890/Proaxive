...
<table border="0" cellpadding="0" cellspacing="0" align="center"  width="580px"  style="border-bottom:thick #FFFFFF solid; margin-top:0px;"  >
 ...
 <tr valign="middle" bgcolor="#404041"  height="25" >
  ...
  <td   style="color:#ff9600; font-family:Calibri; font-size:12px;" align="center">Designation:</td>
  <td style="color:#fff; font-family:Calibri; font-size:12px;"> &nbsp; {{$designation}}</td>
 </tr>
 <tr>
...
<table border="0" cellpadding="0" cellspacing="0" align="center"  width="580" style=" border:thin solid #eee;">
  ...
  <td style=" font-size:12px;font-family:Calibri; ">
    ...
    <table    border="0" bordercolor="#CCCCCC" cellpadding="0" cellspacing="2" align="center"  width="570px" style="color:#0d6e8c; font-family:Calibri; font-size:12px;border-top:thick #FFFFFF solid;">
      ...
      <tr valign="bottom">
       ...
       <td  width="170" style="color:#0d6e8c;" bgcolor="#dfebf4"> &nbsp; {{$request_no}}</td>
       <td width="120" style="color:#222; " bgcolor="#dfebf4"> &nbsp; Employee Name</td>
       <td  width="170" style="color:#0d6e8c; " bgcolor="#dfebf4"> &nbsp; {{$emp_name}}</td>
      </tr>
      <tr>
       <td style="color:#222; " bgcolor="#dfebf4"> &nbsp; Travel Purpose</td>
       <td style="color:#0d6e8c;  " bgcolor="#dfebf4"> &nbsp; {{$purpose}}</td>
          <td style="color:#222;  " bgcolor="#dfebf4"> &nbsp; Departure</td>
          <td style="color:#0d6e8c;  " bgcolor="#dfebf4"> &nbsp; {{$source}}</td>

      </tr>
      <tr>
       <td style="color:#222;  " bgcolor="#dfebf4"> &nbsp; Departure Date</td>
       <td style="color:#0d6e8c;  " bgcolor="#dfebf4"> &nbsp; {{$departure_date}}</td>
          <td style="color:#222; " bgcolor="#dfebf4"> &nbsp; Destination</td>
          <td style="color:#0d6e8c; " bgcolor="#dfebf4"> &nbsp; {{$destination}}</td>
      </tr>
		...
		<td style="color:#222;  " bgcolor="#dfebf4"> &nbsp; Class</td>
            <td style="color:#0d6e8c;  "  bgcolor="#dfebf4"> &nbsp; {{$class}} </td>
			@if($return_date!='')
                <td style="color:#222;  " bgcolor="#dfebf4"> &nbsp; Return Date</td>
                <td style="color:#0d6e8c;  " bgcolor="#dfebf4"> &nbsp; {{$return_date}}</td>
			@endif
            </tr>
      ...
      <tr>
       ...
       <td style="color:#0d6e8c;  " colspan="3" bgcolor="#dfebf4"> &nbsp; {{$comment}} </td>
 ...
 <td>
   <table  height="62" border="0"  bgcolor="#f6fbff"  cellpadding="0" cellspacing="0" align="left"  width="100%" style="color:#0d6e8c; font-family:Calibri; font-size:12px;  margin-left:5px; border:#CCCCCC dotted thin; ">
      <tr>
       <td width="75" style="color:#222; " > &nbsp; View Details</td>
       <td  width="75" style="color:#0d6e8c; text-align:right"><img src="{{asset('img/email_images/arrow.png')}}" /> &nbsp; </td>
       <td width="" style="color:#222; text-align:left;font-size:14px; "><a href="{{$redirection_url}}" style="color:#000000; text-decoration:none">Click Here  </a>&nbsp; </td>
      </tr>
   ...
   <!-- <table  border="0" cellpadding="0" cellspacing="0">
     <tr height="62">
      <td width="200" align="center">
       <img src="{{asset('img/email_images/inprogress.png')}}" />
      </td>
     </tr>
    </table> -->
