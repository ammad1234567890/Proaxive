            ...
            <tr height="25">
                <td width="578" >
                    <table border="0" bordercolor="#6ea2cc" cellpadding="0" cellspacing="0">
                        <tr height="25">
                            <td width="578"style="color:#333; font-family:Calibri; font-size:14px;" bgcolor="#ff9600"><b> &nbsp; Travel Expense Details</b></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td style=" font-size:12px;font-family:Calibri; ">
                    <table    border="0" bordercolor="#CCCCCC" cellpadding="0" cellspacing="2" align="center"  width="100%" style="color:#0d6e8c; font-family:Calibri; font-size:12px;border-top:thick #FFFFFF solid;">
                        <tr valign="bottom">
                            <td width="120" style="color:#222;" bgcolor="#dfebf4"> &nbsp; Expense Claim No # </td>
			 ...
			 <tr>
				...
				<h4 style="font-family:Calibri; margin-top:10px; ">  &nbsp; Approval </h4>
                    ...
                    <table  width="100%" height="62" border="0"  bgcolor="#f6fbff"  cellpadding="0" cellspacing="0" align="left">
						     <tr height="30" >
                            <td style=" color:#333" width="20%">
                                &nbsp;  HR Secretary ({{$role_name}})  
                            </td>
							<td style=" color:#333" width="20%">
							<b>({{$status->name}})</b>
							</td>
				...
				<br>
                    <table  height="62" border="0"  bgcolor="#f6fbff"  cellpadding="0" cellspacing="0" align="left"  width="100%" style="color:#0d6e8c; font-family:Calibri; font-size:12px;   border:#CCCCCC dotted thin; ">
                        <tr>
                            ...
                            <td width="50" style="color:#222; text-align:center; font-size:14px; "><a href="{{$redirection_url}}" style="color:#000000; text-decoration:none">Click Here </a>&nbsp; </td> 
                        </tr>
