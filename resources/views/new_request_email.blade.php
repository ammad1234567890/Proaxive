      ...
      <tr>
       ...
       <td style="color:#0d6e8c;  " bgcolor="#dfebf4"> &nbsp; {{$departure_date}}</td>
        ...
        <tr>
            ...
            <td style="color:#0d6e8c;  " colspan="3" bgcolor="#dfebf4"> &nbsp; {{$class}} </td>
 ...
 <td>
   <table  height="62" border="0"  bgcolor="#f6fbff"  cellpadding="0" cellspacing="0" align="left"  width="360px" style="color:#0d6e8c; font-family:Calibri; font-size:12px;  margin-left:5px; border:#CCCCCC dotted thin; ">
      <tr>
       ...
       <td width="100" style="color:#222; text-align:center "><a href="{{$redirection_url}}" style="color:#000000; text-decoration:none">Click Here </a>&nbsp; </td>
      </tr>
