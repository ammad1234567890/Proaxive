            ...
            <tr>
                <td>
                    <table width="570" style="color:#0d6e8c; font-family:Calibri; font-size:11px;">
                        <tr height="30" >
                            <td style=" color:#333">
                                &nbsp;  This is a system generated email for travel expense Proaxive.  <br />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table  height="62" border="0"  bgcolor="#f6fbff"  cellpadding="0" cellspacing="0" align="left"  width="360px" style="color:#0d6e8c; font-family:Calibri; font-size:12px;  margin-left:5px; border:#CCCCCC dotted thin; ">
                        <tr>
                            <td width="100" style="color:#222;"> &nbsp; View Travel Expense </td>
                ...
                <td>
                    <table width="570" style="color:#0d6e8c; font-family:Calibri; font-size:11px;">
                        <tr height="30" >
                            ...
                            <td style=" color:#333">
                                This is a system generated email, for further queries on this please contact Proaxive system Administrator.
                            </td>
                        </tr>
                    </table>
                </td>
