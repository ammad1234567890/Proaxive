                        ...
                        <p class="mg-b-20 mg-sm-b-30">
                          <label class="form-control-label">TR# <b> {{$single['request_no']}}</b></label> |
                            ...
                            @if($single['is_resubmit_entry']==1)
                                ...
                                <b style="color:green;">(Resubmitted Request)</b>
                                @endif
...
@if($single['status']['id']==1)
                                ...
                                @elseif($single['status']['id']==3)
                                    <span class="cursorpointer status_tag" style="background:red; display: inline-block; padding:5px; color:#fff; border-radius:5px;"><i class="fa fa-ban" style="color: white;" title="Rejected"></i> {{$single['status']['name']}}</span>
...
<script>
   ...
   $(".status_tag").click(function(){
    $(".approval_workflow").fadeToggle();
        ...
        $('#resubmit_form').on('submit', function() {
                $('#submit_travel').attr('disabled', true);
                $('#submit_travel').html('Please wait');
        });
