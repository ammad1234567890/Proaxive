                    ...
                    <div class="form-layout">
                        <form method="post" action="{{url('/create_member')}}" enctype="multipart/form-data">
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Passport Attachment: <span class="tx-danger">*</span></label>
                                        <input class="form-control" type="file" name="passport_attachment"  accept=".jpg,.jpeg,.png,.doc,.docx,.pdf" required>
                                    </div>
                                </div><!-- col-4 -->
