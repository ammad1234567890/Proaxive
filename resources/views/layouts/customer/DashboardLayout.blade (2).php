            ...
            <div id="mainMenu" class="tab-pane active">
                <ul class="nav am-sideleft-menu">
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/travel_request')}}" class="nav-link">New Travel Request</a></li>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link with-sub">
                          ...
                          <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/expense/add')}}" class="nav-link">New Expense Claim</a></li>
                            <li class="nav-item"><a href="{{url('/expense/grid')}}" class="nav-link">Expense Claim List </a></li>
                        </ul>
                    </li><!-- nav-item -->
                  <!--  <li class="nav-item">
                        <a href="#" class="nav-link with-sub">
