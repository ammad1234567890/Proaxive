                    ...
                    <div class="dropdown dropdown-profile">
                        ...
                        <div class="dropdown-menu wd-200">
                            <ul class="list-unstyled user-profile-nav">
                                <li><a href="#"><i class="icon ion-ios-person-outline"></i> <?php
                                ...
                                <li><a href="{{url('md_account_settings')}}"><i class="icon ion-ios-gear-outline"></i> Settings</a></li>
                ...
                <div class="tab-content">
                    <div id="mainMenu" class="tab-pane active">
                        <ul class="nav am-sideleft-menu">
                            ...
                            <li class="nav-item">
                                <a href="{{url('/proceed_travel')}}" class="nav-link ">
                                    <i class="icon ion-ios-briefcase-outline tx-24"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav-sub">
                                    <li class="nav-item"><a href="{{url('/md/expense/grid')}}" class="nav-link">Expense Claim List </a></li>
                                </ul>
                            </li><!-- nav-item -->
                            <li class="nav-item"><a href="#" class="nav-link with-sub  "><i class="icon ion-android-checkmark-circle">
                                    </i><span>My Approvals</span></a>
                                <ul class="nav-sub">
                                    <li class="nav-item"><a href="{{url('/md_approvals_list')}}" class="nav-link">Travel Request</a></li>
