            ...
            <div class="dropdown dropdown-profile">
                ...
                <div class="dropdown-menu wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="#"><i class="icon ion-ios-person-outline"></i> <?php if(Auth::user()->role_id==1){echo "Admin";}else if(Auth::user()->role_id==2){echo "Human Resource";}else if(Auth::user()->role_id==3){echo "Customer";} ?></a></li>

                        <li><a href="{{url('hr_account_settings')}}"><i class="icon ion-ios-gear-outline"></i> Settings</a></li>
            ...
            <div id="mainMenu" class="tab-pane active">
                <ul class="nav am-sideleft-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/customer_travel_request')}}" class="nav-link">New Travel Request</a></li>
                            <li class="nav-item"><a href="{{url('/travel_list')}}" class="nav-link">Travel Request List </a></li>
                       ...
                       <li class="nav-item">
                        <a href="#" class="nav-link with-sub">
                          ...
                          <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/all/expense/grid')}}" class="nav-link">Expense Claim List  </a></li>
                        </ul>
                    </li><!-- nav-item -->

                    <li class="nav-item"><a href="#" class="nav-link with-sub  "><i class="icon ion-android-checkmark-circle">
                            </i><span>My Approvals</span></a>
                        <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/hr_approvals_list')}}" class="nav-link">Travel Request</a></li>
                            <li class="nav-item"><a href="expense_claim_approval.html" class="nav-link">Expense Claim  </a></li>
