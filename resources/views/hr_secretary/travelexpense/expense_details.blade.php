                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="../../../expense_status_update">
                            ...
                            <table class=" no-border" width="100%"  style=" border:0; background:none;">
								...
								<tr>
                                        <td colspan="2"><textarea width="100%" placeholder="Type your comment" class="form-control" name="comment" id="comment"></textarea> <br/></td>
                                    ...
                                    <tr>
										...
										<td>
										&nbsp; &nbsp; <button class="btn btn-primary mg-r-5 btn_disable_submit" type="submit" ><span class="btn_text"> Submit</span></button>
										</td>
                                    </tr>
