        ...
        <div id="wizard1">
            <section>
                <div class="form-layout">
                    <form  class="ng-pristine ng-invalid ng-invalid-required" method="post" action="../../expense/save" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <input type="hidden" name="user" id="user" value="hrsecretary"/>
						<input type="hidden" name="last_id" id="last_id" value="@if($data['last_id']!=""){{$data['last_id']->id+=1}}@else 1 @endif"/>
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Employee: </label>
                                    <select class="form-control   ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"  name="employee_id" id='employee'>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text"  id="on_account_of" name="on_account_of" maxlength="64" />
...
$(document).ready(function () {  
	...
	setTimeout(function(){ $("#add_more_expense").click(); });
})
</script>
@endsection
<style>
