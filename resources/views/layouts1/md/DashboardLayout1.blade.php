            ...
            <div class="dropdown dropdown-profile">
                ...
                <div class="dropdown-menu wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="#"><i class="icon ion-ios-person-outline"></i> <?php if(Auth::user()->role_id==1){echo "MD";}else if(Auth::user()->role_id==2){echo "Human Resource";}else if(Auth::user()->role_id==3){echo "Customer";} ?></a></li>
        ...
        <div class="tab-content">
            <div id="mainMenu" class="tab-pane active">
                <ul class="nav am-sideleft-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{url('/proceed_travel')}}" class="nav-link active">
