            ...
            <div id="mainMenu" class="tab-pane active">
                <ul class="nav am-sideleft-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/customer_travel_request')}}" class="nav-link">Create Travel Request</a></li>
                       ...
                       <li class="nav-item">
                        <a href="#" class="nav-link with-sub">
                          ...
                          <ul class="nav-sub">
                            <li class="nav-item"><a href="{{url('/all/expense/grid')}}" class="nav-link">Travel Expense List </a></li>
                        </ul>
                    </li><!-- nav-item -->
                    <li class="nav-item">
                        <a href="#" class="nav-link with-sub">
